...
//import createHead from './head_cohyd';
//import createBody from './body_cohyd';
...
fs.open(myArgs[0], "r", (err, file) => {
    ...
    fs.readFile(file, (err,data) =>{
        ...
        //createHead(nomes_pages, dados.split("BODY")[0].split(';'));
        //createBody(nomes_pages, dados.split("ENDHEAD;")[1]);
